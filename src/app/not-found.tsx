  ...
  return (
    <section className='w-full h-screen flex justify-center items-center flex-col '>
        <Image 
            ...
            height={450}
        />
        <h1 className='text-5xl text-green font-heading font-bold mb-5'>Oops!</h1>
        <h2 className='text-xl text-black mb-5'>Your are lost... We can&apos;t find the page you&apos;re looking for.</h2>
        <Link 
            href="/"
