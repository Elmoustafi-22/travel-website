        ...
        <div className="py-20 bg-black bg-opacity-20">
          <div className="container mx-auto px-4">
            ...
            <p className="font-body text-sm text-black w-full max-w-[750px]">
              ...
              Omnis fuga reiciendis, repellendus maiores numquam rem quaerat
              quos labore qui dolores sit ipsum dolor assumenda cum quasi explicabo beatae at cumque.
            </p>
            ...
            {imgPop && (
                ...
                <div>
                    <Image 
                        ...
                        height={500}
                        width={650}
                        className='w-full max-w-[650px] max-h-[400px]'
                    />
                    <h3 className='text-center text-white font-bold uppercase text-3xl mt-3'>{db.gallery[selectedImg].location}</h3>
                </div>
                <a 
                ...
                <nav className='absolute left-0 right-0 bottom-5 flex justify-center gap-3 px-4'>
                    {db.gallery.map((loc: gallery, i: number) => {
                        return (
                            <a 
